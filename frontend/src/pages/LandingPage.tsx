// Implements the Figma design in `frontend/Redesign landing page/src/app/App.tsx`,
// wired to real routes, using the real Horizon logo, and tightened for phones.
...
function InsightSection() {
  ...
  useEffect(() => {
    if (!on) return;
    // Count-up: 0 → 90 over ~1.6s with ease-out cubic
    let frame = 0;
  ...
  return (
    <section ref={ref} className="py-16 md:py-20 px-5 sm:px-6" style={{ borderTop: "1px solid rgba(182,177,217,0.08)" }}>
      <div className="max-w-6xl mx-auto">
        <div className="rounded-2xl p-6 sm:p-10 md:p-14"
          ...
          <div className="grid lg:grid-cols-5 gap-10 lg:gap-16 items-start">
            ...
            {/* Left: headline fills the column (3/5) */}
            <div className="lg:col-span-3 flex flex-col gap-8">

              {/* Headline — each line slides in from left with stagger */}
              <div>
                {[
              ...
              {/* Supporting text — appears after headline settles */}
            ...
            {/* Right: count-up stat + bars (2/5) */}
            <div className="lg:col-span-2 flex flex-col gap-7 lg:pl-6">

              {/* Count-up — 90% and 25% side by side */}
              <div style={fade(160)}>
...
function CyclingWord({ words, interval = 1800 }: { words: string[]; interval?: number }) {
  ...
  useEffect(() => {
    ...
    return () => { clearInterval(cycle); if (swap) clearTimeout(swap); };
  }, [words, interval]);
...
const CYCLING_WORDS = ["constantly", "privately", "invisibly"];
    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#211d45", color: "#f5f3ff", minHeight: "100vh" }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 flex items-center justify-between h-14">
          <Link to="/" className="flex items-center" aria-label="Horizon home">
      ...
      {/* ── HERO ── */}
      <section className="relative pt-24 sm:pt-28 pb-14 sm:pb-16 px-5 sm:px-6 overflow-hidden">
      ...
      {/* ── SOLUTION + CTA ── */}
      <section className="py-16 px-5 sm:px-6" style={{ borderTop: "1px solid rgba(182,177,217,0.08)" }}>
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="mb-8" style={{ fontFamily: "'Instrument Serif', serif", fontSize: "clamp(1rem, 1.8vw, 1.2rem)", color: "#f5f3ff", lineHeight: 1.5 }}>
            Whether you're a student or an educator —<br className="hidden sm:block" /> see how Horizon works for your role.
          </p>
      ...
      {/* ── FOOTER ── */}
      <footer className="px-5 sm:px-6 py-8" style={{ borderTop: "1px solid rgba(182,177,217,0.07)" }}>
