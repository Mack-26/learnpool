...
export default function ProfessorClassListPage() {
  ...
  return (
    <DashboardLayout>
      ...
      >
        ...
        <p className="text-muted-foreground mb-6">Manage your classes and lectures</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {courses?.map((course, i) => (
            ...
            >
              <ClassCard
                name={course.name}
                professor={`${course.professor_name} (You)`}
                status="past"
